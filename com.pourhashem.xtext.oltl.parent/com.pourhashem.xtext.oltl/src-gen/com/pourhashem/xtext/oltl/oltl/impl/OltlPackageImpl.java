...
public class OltlPackageImpl extends EPackageImpl implements OltlPackage
{
   ...
   * @generated
   */
  private EClass softFormulaEClass = null;
   ...
   * @generated
   */
  private EClass softAllTIEClass = null;
   ...
   * @generated
   */
  private EClass softTIEClass = null;
   ...
   * @generated
   */
  public EAttribute getModel_Bound()
  {
   ...
   * @generated
   */
  public EAttribute getModel_SoftBound()
  {
   ...
   * @generated
   */
  public EReference getModel_SoftFormulae()
  {
   ...
   * @generated
   */
  public EClass getSoftFormula()
  {
    return softFormulaEClass;
  }
   ...
   * @generated
   */
  public EReference getSoftFormula_SoftAll()
  {
    return (EReference)softFormulaEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getSoftFormula_SoftAt()
  {
    return (EReference)softFormulaEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EClass getSoftAllTI()
  {
    return softAllTIEClass;
  }
   ...
   * @generated
   */
  public EReference getSoftAllTI_Ap()
  {
    return (EReference)softAllTIEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getSoftAllTI_Id()
  {
    return (EAttribute)softAllTIEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getSoftAllTI_Weight()
  {
    return (EReference)softAllTIEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getSoftTI_Ap()
  {
    return (EReference)softTIEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getSoftTI_Ti()
  {
    return (EAttribute)softTIEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EAttribute getSoftTI_Id()
  {
    return (EAttribute)softTIEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getSoftTI_Weight()
  {
    return (EReference)softTIEClass.getEStructuralFeatures().get(3);
  }
  ...
  {
    return (EReference)weightEClass.getEStructuralFeatures().get(0);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(modelEClass, MODEL__BOUND);
    createEAttribute(modelEClass, MODEL__SOFT_BOUND);
    createEReference(modelEClass, MODEL__TEMP_FORMULA);
    createEReference(modelEClass, MODEL__SOFT_FORMULAE);

    softFormulaEClass = createEClass(SOFT_FORMULA);
    createEReference(softFormulaEClass, SOFT_FORMULA__SOFT_ALL);
    createEReference(softFormulaEClass, SOFT_FORMULA__SOFT_AT);

    softAllTIEClass = createEClass(SOFT_ALL_TI);
    createEReference(softAllTIEClass, SOFT_ALL_TI__AP);
    createEAttribute(softAllTIEClass, SOFT_ALL_TI__ID);
    createEReference(softAllTIEClass, SOFT_ALL_TI__WEIGHT);

    softTIEClass = createEClass(SOFT_TI);
    createEReference(softTIEClass, SOFT_TI__AP);
    createEAttribute(softTIEClass, SOFT_TI__TI);
    createEAttribute(softTIEClass, SOFT_TI__ID);
    createEReference(softTIEClass, SOFT_TI__WEIGHT);
    ...
    createEAttribute(apEClass, AP__NAME);
  }
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getModel_Bound(), ecorePackage.getEInt(), "bound", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getModel_SoftBound(), ecorePackage.getEInt(), "softBound", null, 0, 1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getModel_SoftFormulae(), this.getSoftFormula(), null, "softFormulae", null, 0, -1, Model.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(softFormulaEClass, SoftFormula.class, "SoftFormula", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSoftFormula_SoftAll(), this.getSoftAllTI(), null, "softAll", null, 0, 1, SoftFormula.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSoftFormula_SoftAt(), this.getSoftTI(), null, "softAt", null, 0, 1, SoftFormula.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(softAllTIEClass, SoftAllTI.class, "SoftAllTI", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSoftAllTI_Ap(), this.getAP(), null, "ap", null, 0, 1, SoftAllTI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSoftAllTI_Id(), ecorePackage.getEString(), "id", null, 0, 1, SoftAllTI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSoftAllTI_Weight(), this.getWeight(), null, "weight", null, 0, 1, SoftAllTI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(softTIEClass, SoftTI.class, "SoftTI", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getSoftTI_Ap(), this.getAP(), null, "ap", null, 0, 1, SoftTI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSoftTI_Ti(), ecorePackage.getEInt(), "ti", null, 0, 1, SoftTI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getSoftTI_Id(), ecorePackage.getEString(), "id", null, 0, 1, SoftTI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getSoftTI_Weight(), this.getWeight(), null, "weight", null, 0, 1, SoftTI.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getAP_Name(), ecorePackage.getEString(), "name", null, 0, 1, com.pourhashem.xtext.oltl.oltl.AP.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
