...
public interface OltlFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Soft Formula</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Soft Formula</em>'.
   * @generated
   */
  SoftFormula createSoftFormula();

  /**
   * Returns a new object of class '<em>Soft All TI</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Soft All TI</em>'.
   * @generated
   */
  SoftAllTI createSoftAllTI();

  /**
   * Returns a new object of class '<em>Soft TI</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Soft TI</em>'.
   * @generated
   */
  SoftTI createSoftTI();
