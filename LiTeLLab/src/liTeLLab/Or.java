...
public class Or extends OLTLFormula {
	ArrayList<OLTLFormula> f = new ArrayList<OLTLFormula>();

	public Or(OLTLFormula... formulae) {
		super();
	...
	public Or(ArrayList<OLTLFormula> formulae) {
		super();
	...
	public boolean equals(Object o) {
		if (o instanceof Or) {
			...
			ArrayList<OLTLFormula> a2 = ((Or) o).getFormulae();
			if (a1.size() != a2.size())
				return false;
